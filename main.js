import { obtenerDolar } from "./obtenerDolar.js"
import { transacciones } from "./transacciones.js"
import { graficarBarra } from "./graficarBarras.js"
import { graficarDona } from "./graficarDona.js"
...
function agregarGastos(){
    ...
    let categoria = prompt("Ingrese la categoría del gasto (Viajes, Servicios, Supermercado o Transporte");
    let mes = prompt("Ingrese el número de mes en que se efectuó el gasto (1-Enero, 12-Diciembre)");
    while(isNaN(mes) || mes<1 || mes>12){
        mes = prompt("Ingrese el número de mes en que se efectuó el gasto (1-Enero, 12-Diciembre)");
    }
    let costo = prompt("Ingrese el monto del gasto");
...
document.addEventListener("DOMContentLoaded", obtenerDolar);
